---
title: "v_plants glimpse for LLM"
...
if (is.null(plants_path)) {
  stop("Could not find plants_export/v_plants_allt.csv from working directory or its parent.")
}
...
cat("meta:", nrow(meta), "x", ncol(meta),
    "  mat:", nrow(mat), "x", ncol(mat), "\n\n")
...
if (!is.null(fit_strict$vectors)) {
  print(fit_strict$vectors)
}
cat("\n")

cat("--- nmds_strict (metaMDS) ---\n")
cat("converged:", nmds_strict$convergence,
    " stress:", nmds_strict$stress, "\n")
